...
> ⚠️ **Deprecated.** This flat glossary has been migrated to the domain-structured [`doctrine/glossary/`](./glossary/) hierarchy.
> The content below is preserved for historical reference only. New terms and updates should be made in the domain-specific README files.
> **Navigation:** [`doctrine/glossary/README.md`](./glossary/README.md)
...
This glossary provides standardized definitions for terms used throughout the Regnology Professional Services Framework. These definitions ensure consistent understanding and communication across all agents, directives, and collaborative workflows.
