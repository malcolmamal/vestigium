...
- [ ] Add metrics block to task result template (`doctrine/templates/agent-tasks/task-result.yaml`)
...
- **Task Templates**: `doctrine/templates/agent-tasks/` (task descriptor formats)
