...
**Integration Points:**
- Task YAML schema in `doctrine/templates/agent-tasks/task-descriptor.yaml`
...
**Location:** `doctrine/templates/prompts/`
...
**Deliverables:**
1. Create 5 canonical prompt templates in `doctrine/templates/prompts/`
   - `task-execution.yaml`
   - `bug-fix.yaml`
   - `documentation.yaml`
