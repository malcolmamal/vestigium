...
Add 5-10 agent-specific examples to `doctrine/templates/agent-tasks/task-examples.yaml`:
...
- **Task Templates:** `doctrine/templates/agent-tasks/task-templates-README.md`
