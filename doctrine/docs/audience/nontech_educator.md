# Persona: Non-Technical Teacher (Humanities, Social Sciences, Life Sciences)
...
* **Emotional or Cognitive Drivers:
  ** Values efficiency, clarity, and classroom impact. Seeks tools that reduce prep burden, not add technical complexity.
...
* **Pain Points:
  ** Overwhelmed by repetitive prep, struggles to find relevant material, wary of “hallucinated” AI content, not wanting to debug tech problems.
...
A dedicated educator in non-technical subjects, eager to make the most of practical digital tools. Draws on repositories like this one for tested prompts, checklists, and generation templates to lighten the burdens of material preparation and spark creativity in lesson planning, all without wanting to navigate tech intricacies.
...
| Field                 | Value                                            |
|-----------------------|--------------------------------------------------|
| **Persona ID**        | `UUID-TEACHER-NT-001`                            |
