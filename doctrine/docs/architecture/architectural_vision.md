...
### Layer 4: Templates (doctrine/templates/)
...
1. Use template: `doctrine/templates/automation/NEW_SPECIALIST.agent.md`
...
2. Create in appropriate `doctrine/templates/<category>/` subdirectory
