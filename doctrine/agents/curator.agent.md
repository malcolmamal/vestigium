...
| 007  | [Agent Declaration & Self-Introduction](directives/007_agent_declaration.md)                       | Affirm authority prior to large-scale normalization                     |
...
.cursor/              # Cursor
├── rules/           # Glob-scoped editing rules (4) + quick-reference
├── skills/          # 34 skills from approaches, tactics, shorthands
├── hooks.json       # afterFileEdit + preToolUse hooks
...
```
✅ Regnology Agent “Curator Claire” initialized.
