...
Directives are explicit instructions and constraints for agent behavior. Each directive is numbered (001-042+) for load-on-demand efficiency and prescribes what must or must not be done in specific situations.
...
| 007  | [Agent Declaration & Self-Introduction](./007_agent_declaration.md) | Operational authority affirmation and user-facing self-introduction |
...
| 040  | [Human-in-Charge Escalation](./040_human_in_charge_escalation_protocol.md) | Structured agent-to-human escalation |
| 041  | [Use Regnology Branding](./041_use_regnology_branding.md) | Mandatory branding headers and license in all repos |
| 042  | [Model Discipline](./042_model_discipline.md) | LLM model selection by arena and cost tier; high-ROI execution |
| 043  | [Use Corporate Tooling](./043_use_corporate_tooling.md) | Standards for Jira, Confluence, and corporate tool interactions |
