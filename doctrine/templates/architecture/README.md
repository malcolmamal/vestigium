...
- **[user_journey.md](user_journey.md)** - User Journey template
  - End-to-end multi-actor workflows across system boundaries
  - Actor attribution, coordination rules, domain events
  - Acceptance scenarios and scope boundaries
  - **Usage:** For flows involving multiple actors (humans, agents, services) that cross system boundaries
  - **Target:** `${DOC_ROOT}/architecture/journeys/[journey-slug].md`
...
| user_journey.md | Mapping multi-actor cross-boundary workflows | `${DOC_ROOT}/architecture/journeys/` |
