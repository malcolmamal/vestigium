...
tools: [ "read", "write", "search", "edit", "MultiEdit", "Bash", "Grep", "Java", "Maven", "regnology-mcp" ]
...
| 007  | [Agent Declaration & Self-Introduction](directives/007_agent_declaration.md)                       | Authority confirmation prior to code changes                        |
...
```
✅ Regnology Agent "Java Jenny" initialized.
