...
tools: [ "read", "write", "search", "edit", "MultiEdit", "Bash", "Grep", "Docker", "Java", "Python", "regnology-mcp" ]
routing_priority: 50
...
- **Regnology MCP Server:** `regnology-mcp` — Jira, Bitbucket, Confluence, rcloud (task tracking, code review via Bitbucket, API docs via Confluence, instance management via rcloud)
...
| 007  | [Agent Declaration & Self-Introduction](directives/007_agent_declaration.md)                                   | Authority confirmation prior to backend refactor proposals                    |
