...
tools: [ "read", "write", "search", "edit", "web", "bash", "grep", "regnology-mcp" ]
---
...
- **Regnology MCP Server:** `regnology-mcp` — Jira, Bitbucket, Confluence, rcloud (internal knowledge base via Confluence, issue context via Jira, product landscape via rcloud)
...
| 007  | [Agent Declaration & Self-Introduction](directives/007_agent_declaration.md)                       | Authority confirmation before large research summary commits     |
...
```
✅ Regnology Agent “Researcher Ralph” initialized.
