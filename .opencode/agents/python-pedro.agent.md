...
tools: ["read", "write", "edit", "MultiEdit", "Bash", "Grep", "Python", "pytest", "ruff", "mypy", "black", "regnology-mcp"]
...
| 007  | [Agent Declaration & Self-Introduction](directives/007_agent_declaration.md)                                   | Authority confirmation prior to Python refactor proposals                               |
...
```
✅ Regnology Agent "Python Pedro" initialized.
